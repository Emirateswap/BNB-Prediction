...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://emirateswap.com/presale", target: "_blank" },
        ...
        React__default['default'].createElement(Text, { color: color, bold: true }, "$0.005"))) : (React__default.createElement(PriceLink, { href: "https://emirateswap.com/presale", target: "_blank" },
        React__default.createElement(Icon$1h, { width: "24px", mr: "8px" }), React__default.createElement(Text, { color: color, bold: true }, "$0.005")));
};
