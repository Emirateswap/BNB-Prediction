...
const eventDescriptionConfigBuilder = ({ t }: EventDescriptionType) => ({
  ...
  image: { src: '/bnb/images/pancakeSquad/moonBunny/body.png', alt: 'moon bunny' },
  accessoriesImages: [
    { src: '/bnb/images/pancakeSquad/moonBunny/band.png', alt: 'headband' },
    { src: '/bnb/images/pancakeSquad/moonBunny/cloth.png', alt: 'cloth' },
    { src: '/bnb/images/pancakeSquad/moonBunny/glasses.png', alt: 'glasses' },
    { src: '/bnb/images/pancakeSquad/moonBunny/pancake.png', alt: 'pancake' },
  ],
})
